...
namespace ylib::math {
    ...
    public:
        ...
        T min() {
            ...
            if (s == 0) {
                throw Exception("Since there is no element, there is no minimum.");
            }
        ...
        T max() {
            ...
            if (s == 0) {
                throw Exception("Since there is no element, there is no maximum.");
            }
        ...
        double sum() {
            ...
            //let's start using the first element, and let operator overloading do its job
